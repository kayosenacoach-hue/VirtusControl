...
serve(async (req) => {
  ...
  try {
    ...
    // 1. Busca a assinatura no banco de dados para confirmar se ela pertence ao usuário logado
    ...
    // 3. Atualiza o status no banco de dados para refletir o cancelamento agendado
